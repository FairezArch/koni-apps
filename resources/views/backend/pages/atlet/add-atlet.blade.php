                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea name="domicile_address" class="form-control" id="domicile_address" cols="30" rows="5"
                                    class="w-100"></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="file_ktp_atlet" class="col-sm-2 col-form-label">Foto KTP</label>
                            <div class="col-sm-10">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            <label for="file_npwp" class="col-sm-2 col-form-label">Foto NPWP</label>
                            <div class="col-sm-10">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="inputGroupFileAddon01">Upload</span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input file_atlet_status" id="file_atlet_status"
                                            aria-describedby="inputGroupFileAddon01" name="file_atlet_status">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="nomor_status_atlet" id="nomor_status_atlet" class="form-control" >
                            </div>
                        </div>
                    </div>
                </div>
                <div class="text-right">
                    <a href="{{ route('atlet.index') }}" class="btn btn-danger p-2 rounded">Kembali</a>
        ...
        $('#forminput').on('submit', function(e) {
            ...
            $.ajax({
                ...
                success: function(res) {
                    if (res.success == true) {
                        window.location.href = "{{ route('atlet.index') }}"
                    } else {
                        alert(res.message);
                    }
                },
