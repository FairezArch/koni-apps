                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea name="domicile_address" class="form-control" id="domicile_address" cols="30"
                                    rows="5" class="w-100">{{ $lists->domicile_address }}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="nomor_ktp" value="{{$lists->nomor_nik_ktp}}" id="nomor_ktp" class="form-control" >
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="nomor_sk_training" value="{{$lists->nomor_sk_training}}" id="nomor_sk_training" class="form-control" >
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="nomor_status_atlet" value="{{$lists->nomor_status_atlet}}" id="nomor_status_atlet" class="form-control" >
                            </div>
                        </div>
                    </div>
                </div>
...
@section('script-footer')
    ...
    <script type="text/javascript">
        ...
        $('#forminput').on('submit', function(e) {
            ...
            $.ajax({
                url: "{{ route('atlet.update', $lists->id) }}",
                type: "POST",         
                processData: false,
                contentType: false,
                data: formData,
