...
@section('title', '- Permintaan Berita')
@section('content')
            ...
            <div class="w-100 mt-3 mb-3">
                <div class="row">
                    ...
                    <div class="col-md-3 text-right">
                        @can('news-requestnews-create')
                            <a class="btn btn-danger" href="{{ route('tidings-request.create') }}">Tambah Permintaan</a>
                        @endcan
                    </div>
                </div>
            </div>
            ...
            let table = $('#dataTable_requestnews').DataTable({
                    ...
                    columns: [
                        ...
                        },
                        {
                            ...
                            searchable: false,
                            render: (dataField) => {
                                return `@can('news-requestnews-edit')
                                    <a href="{{ url('tidings-request/`+dataField+`/edit') }}" class='edit m-1 pointer'>
                ...
                $('body').on('click', '.delete-record',  function(e) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            let url = "{{ route('tidings-request.index') }}";
                            $.ajax({
                                url: url + '/' + id,
                                type: 'DELETE',
                                dataType: 'json',
