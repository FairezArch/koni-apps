...
<div class="container-fluid">
    <div class="wrapper-table p-3 bg-white rounded">
        <div class="w-100 mt-3 mb-3 text-right">
            @can('admin-create')
                <a class="btn btn-danger" href="{{route('employ.create')}}">Tambah Jabatan</a>
            @endcan
        </div>
        ...
        columns: [
            ...
            {data: 'action', orderable: false, searchable: false, 
                render: function(dataField){ 
                    return `@can('admin-edit')<a href="{{url('employ/`+dataField+`/edit')}}" class='edit m-1'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
