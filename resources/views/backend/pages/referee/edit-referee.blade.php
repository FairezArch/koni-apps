            ...
            <form id="forminput" class="forminput mt-3 mb-3" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group row">
                            <label for="referee_name" class="col-sm-2 col-form-label">Nama</label>
                            <div class="col-sm-10">
                                <input type="text" value="{{$lists->users->name}}" name="referee_name" id="referee_name" class="form-control">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" value="{{$lists->nik_referees}}" name="nik" id="nik" class="form-control">
                            </div>
                        </div>
                        <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            <label for="file_ktp_referee" class="col-sm-2 col-form-label">Foto KTP</label>
                            <div class="col-sm-10">
                                <div class="input-group">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input file_ktp_referee" id="file_ktp_referee"
                                            aria-describedby="inputGroupFileAddon01" name="file_ktp_referee">
                                        <label class="custom-file-label" for="file_ktp_referee">Choose file</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        @if (!empty($lists->file_ktp_referee))
                        <div class="form-group row">
                            <label for="showfileSecond" class="col-sm-2 col-form-label">&nbsp;</label>
                            <div class="col-sm-10">
                                <div class="d-inline-block" id="show-image"
                                    style="width: 350px; height: auto;">
                                    <img src='{{ url("storage/referee/".$lists->file_ktp_referee) }}'
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" value="{{$lists->npwp_referee}}" name="npwp_number" id="npwp_number" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        @if (!empty($lists->file_npwp_referee))
                        <div class="form-group row">
                            <label for="showfileSecond" class="col-sm-2 col-form-label">&nbsp;</label>
                            <div class="col-sm-10">
                                <div class="d-inline-block" id="show-image"
                                    style="width: 350px; height: auto;">
                                    <img src='{{ url("storage/referee/".$lists->file_npwp_referee) }}'
                                        class="img-fluid img-thumbnail" />
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        @if (!empty($lists->file_certificate_referee))
                        <div class="form-group row">
                            <label for="showfileSecond" class="col-sm-2 col-form-label">&nbsp;</label>
                            <div class="col-sm-10">
                                <div class="d-inline-block" id="show-image"
                                    style="width: 350px; height: auto;">
                                    <img src='{{ url("storage/referee/".$lists->file_certificate_referee) }}'
                                        class="img-fluid img-thumbnail" />
                                </div>
                            </div>
                        </div>
                ...
                <div class="text-right">
                    <a href="{{ route('referee.index') }}" class="btn btn-danger p-2 rounded">Kembali</a>
...
@section('script-footer')
    <script type="text/javascript">
        ...
        $('#forminput').on('submit', function(e) {
            ...
            formData.append('referee_name', $('#referee_name').val());
            ...
            formData.append('file_ktp_referee', $('#file_ktp_referee').get(0).files[0]);
            ...
            $.ajax({
                url: "{{ route('referee.update',$lists->id) }}",
                type: "POST",
                processData: false,
                contentType: false,
                data: formData,
                ...
                success: function(res) {
                    if (res.success == true) {
                        window.location.href = "{{ route('referee.index') }}"
                    } else {
                        alert(res.message);
                    }
                },
