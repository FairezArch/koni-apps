...
<div class="container-fluid">
    <div class="wrapper-table p-3 bg-white rounded">
        <div class="w-100 mt-3 mb-3 text-right">
            @can('referee-create')
                <a class="btn btn-danger" href="{{route('referee.create')}}">Tambah Wasit</a>
            @endcan
        </div>
    ...
    let table = $('#dataTable').DataTable({
        ...
        columns: [
            ...
            {data: 'action', orderable: false, searchable: false, 
                render: function(dataField){ 
                    return `@can('referee-edit')<a href="{{url('referee/`+dataField+`/edit')}}" class='edit m-1'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
