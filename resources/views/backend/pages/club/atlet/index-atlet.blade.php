    ...
    <div class="wrapper-table p-3 bg-white rounded">
        <div class="w-100 mt-3 mb-3 text-right">
            ...
            <div class="text-right">
                <a class="btn btn-danger" href="{{route('club.atlet.create', $club->id)}}">Tambah Atlet</a>
            </div>
            @endcan
        </div>
...
<script type="text/javascript">
  $(function () {  
        ...
        columns: [
            ...
            {data: 'action', orderable: false, searchable: false, 
                render: function(dataField){ 
                    ...
                    return `@can('atlet-edit')<a href="{{url('club/`+splitdata[1]+`/atlet/`+splitdata[0]+`/edit')}}" class='edit m-1'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
    ...
    $('body').on('click', '.delete-record', function(e){
        ...
        let id = $(this).data("id"),
            split  = id.split(','),
            url = "{!!url('club/"+split[1]+"/atlet/"+split[0]+"')!!}";
