                        ...
                        <div class="col-md-3 my-4">
                            <div class="grid-image position-relative">
                                <button type="button" id="modal-button-delete"
                                    class="close position-absolute modal-button-delete" data-id="{{ json_encode(array($club_id, $list->id)) }}"
                    ...
                    <div class="modal-content px-5 py-2">
                        ...
                        <div class="modal-body">
                            <div class="position-relative">
                                <form method="post" action="{{ route('club.photo-gallery.store', $club_id) }}"
        ...
        $('.modal-button-delete').on('click', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    let url = url = "{!!url('club/"+id[0]+"/atlet/"+id[1]+"')!!}";
                    $.ajax({
                        url: url,
                        type: 'DELETE',
                        dataType: 'json',
