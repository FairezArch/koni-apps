        ...
        <div class="shadow-sm p-3 mb-5 bg-white rounded">
            ...
            <form id="forminput" class="forminput mt-3 mb-3" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="email" value="{{ $lists->users->email }}" name="email" id="email" class="form-control">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="phone" class="col-sm-2 col-form-label">Phone</label>
                    <div class="col-sm-10">
                        <input type="text" value="{{ $lists->users->phone }}" name="phone" id="phone" class="form-control">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" value="{{ $lists->npwp_trainner }}" name="npwp_number" id="npwp_number"
                            class="form-control">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4">
                        ...
                        @if (!empty($lists->users->photo))
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <div class="d-inline-block" id="show-image" style="width: 350px; height: auto;">
                                        <img src='{{ url('storage/users/' . $lists->users->photo) }}'
                    ...
                    <div class="col-md-4">
                        ...
                        @if (!empty($lists->file_ktp_trainner))
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <div class="d-inline-block" id="show-image" style="width: 350px; height: auto;">
                                        <img src='{{ url('storage/trainer/' . $lists->file_ktp_trainner) }}'
                                            class="img-fluid img-thumbnail" />
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-4">
                        ...
                        @if (!empty($lists->file_npwp_trainner))
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <div class="d-inline-block" id="show-image" style="width: 350px; height: auto;">
                                        <img src='{{ url('storage/trainer/' . $lists->file_npwp_trainner) }}'
                                            class="img-fluid img-thumbnail" />
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                                ...
                                <select name="clubs_id" id="clubs_id" class="form-control">
                                    @foreach ($clubs as $club)
                                        <option value="{{ $club->id }}"
                                            {{ $res->id == $lists->clubs_id ? 'selected' : '' }}>
                                ...
                                <select name="nomors_id" id="nomors_id" class="form-control">
                                    @foreach ($nomors as $nomor)
                                        <option value="{{ $nomor->id }}"
                                            {{ $res->id == $lists->nomors_id ? 'selected' : '' }}>
                                ...
                                <select name="status_trainner" id="status_trainner" class="form-control">
                                    @foreach ($status_trainners as $status_trainner)
                                        <option value="{{ $status_trainner->id }}"
                                            {{ $res->id == $lists->status_trainners_id ? 'selected' : '' }}>
                                            {{ $status_trainner->status_trainner }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                                ...
                                <select name="certificate_profession" id="certificate_profession" class="form-control">
                                    @foreach ($certificate_professions as $certificate_profession)
                                        <option value="{{ $certificate_profession->id }}"
                                            {{ $certificate_profession->id == $lists->certificate_professions_id ? 'selected' : '' }}>
                                ...
                                <select name="support_trainner[]" id="support_trainner"
                                    ...
                                    @foreach ($support_trainners as $support_trainner)
                                        <option value="{{ $support_trainner->id }}"
                                            {{ in_array($support_trainner->id, json_decode($lists->support_trainners_id)) ? 'selected' : '' }}>
                                            {{ $support_trainner->support_name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            <label for="certificate_profession_file" class="col-sm-2 col-form-label">Bukti Fisik Sertifikat
                                Profesi</label>
                            <div class="col-sm-10">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                        ...
                        @if (!empty($lists->file_certificate_profession))
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <div class="d-inline-block" id="show-image" style="width: 350px; height: auto;">
                                        <img src='{{ url('storage/trainer/' . $lists->file_certificate_profession) }}'
                                            class="img-fluid img-thumbnail" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-10">
                                <select name="training_place" id="training_place" class="form-control">
                                    @foreach ($training_places as $training_place)
                                        <option value="{{ $training_place->id }}"
                                            {{ $training_place->id == $lists->support_trainners_id ? 'selected' : '' }}>
                                            {{ $training_place->place_name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="form-group row  d-none">
                            <label for="certificate_number_trainer" class="col-sm-2 col-form-label">Nomor Sertifikat Tempat
                                Melatih</label>
                            <div class="col-sm-10">
                                <input type="text" value="{{ $lists->certificate_number_place_trainning }}"
                                    name="certificate_number_trainer" id="certificate_number_trainer"
                                    class="form-control">
                            </div>
                        </div>
                        <div class="form-group row  d-none">
                        ...
                        @if (!empty($lists->file_trainning_place))
                            <div class="form-group row  d-none">
                                <label for="showfileSecond" class="col-sm-2 col-form-label">&nbsp;</label>
                                <div class="col-sm-10">
                                    <div class="d-inline-block" id="show-image" style="width: 350px; height: auto;">
                                        <img src='{{ url('storage/trainer/' . $lists->file_trainning_place) }}'
                                            class="img-fluid img-thumbnail" />
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row d-none">
                    <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" value="{{ $lists->certificate_nomor }}" name="certificate_number"
                                    id="certificate_number" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
...
@section('script-footer')
    ...
    <script type="text/javascript">
        ...
        $('#forminput').on('submit', function(e) {
            ...
            $.ajax({
                url: "{{ route('trainner.update', $lists->id) }}",
                type: "POST",
                processData: false,
                contentType: false,
                data: formData,
