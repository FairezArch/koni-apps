...
@section('content')
    <div class="container-fluid">
        <div class="shadow-sm p-3 mb-5 rounded text-white" style="background-color: #3B3A3A;">
            <div class="row m-4">
                <div class="col-md-4">
                    <img src="{{ asset('storage/sport/' . $sport->file_sport) }}" alt="sport image" class="img-fluid">
                </div>
                <div class="col-md-8">
                    <div class="row">
                        <div class="col-md-10">
                            <h4>{{ $sport->sportbranch_name }}</h4>
                        </div>
                        <div class="col-md-2">
                            <div class="text-right">
                                <a href="{{ route('sport-branch.profile.edit', $sport->id) }}" class="text-white">
                    ...
                    <h5>{{ $sport->organization }}</h5>
                    <p>{{ $sport->phone_number_sport }}</p>
                    <p>{{ $sport->email }}</p>
                    <p>{{ $sport->address }}</p>
                </div>
            </div>
            ...
            <div class="row m-4">
                ...
                <div class="col-md-4">
                    <div class="rounded p-3 mt-3 mb-3 wrapper-box-sport">
                        <div class="top-box-sport text-center text-dark">
                            <h5>Nomor</h5>
                            <h6><small>{{ $nomors }} Nomor</small></h6>
                        </div>
                        <div class="border-top border-white mt-3 text-right">
                ...
                <div class="col-md-4">
                    <div class="rounded p-3 mt-3 mb-3 wrapper-box-sport">
                        <div class="top-box-sport text-center text-dark">
                            <h5>Atlet</h5>
                            <h6><small>{{ $atlets }} Atlet</small></h6>
                        </div>
                        <div class="border-top border-white mt-3 text-right">
                ...
                <div class="col-md-4">
                    <div class="rounded p-3 mt-3 mb-3 wrapper-box-sport">
                        <div class="top-box-sport text-center text-dark">
                            <h5>Pelatih</h5>
                            <h6><small>{{ $trainers }} Pelatih</small></h6>
                        </div>
                        <div class="border-top border-white mt-3 text-right">
                ...
                <div class="col-md-4">
                    <div class="rounded p-3 mt-3 mb-3 wrapper-box-sport">
                        <div class="top-box-sport text-center text-dark">
                            ...
                            <h6><small>{{ $referees + $judges }} Wasit & Juri</small></h6>
                        </div>
                        <div class="border-top border-white mt-3 text-right">
