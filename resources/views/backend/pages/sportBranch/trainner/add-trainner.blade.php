        ...
        <div class="shadow-sm p-3 mb-5 bg-white rounded">
            ...
            <form id="forminput" class="forminput mt-3 mb-3" enctype="multipart/form-data">
                                ...
                                <div class="col-sm-12">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="preview-image" id="preview-image">
                                                <img src="{{ asset('assets/def_image.svg') }}" alt="default"
                                                    id="imageLoad_file_ktp_trainner" width="100" height="auto" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="preview-image" id="preview-image">
                                                <img src="{{ asset('assets/def_image.svg') }}" alt="default"
                                                    id="imageLoad_certificate_file" width="100" height="auto" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="text-right">
                    <a href="{{ route('sport-branch.trainer.index', $sport_branch->id) }}"
...
@section('script-footer')
    ...
    <script type="text/javascript">
        ...
        $('#forminput').on('submit', function(e) {
            ...
            $.ajax({
                url: "{!! url('sport-branch/"+sport_id+"/trainer') !!}",
                type: "POST",
                processData: false,
                contentType: false,
                data: formData,
                ...
                success: function(res) {
                    if (res.success == true) {
                        window.location.href = "{!! url('sport-branch/"+sport_id+"/trainer') !!}"
                    } else {
                        alert(res.message);
                    }
                },
    ...
    <script>
        ...
        file_ktp_trainner.onchange = evt => {
            const [file] = file_ktp_trainner.files
            if (file) {
                imageLoad_file_ktp_trainner.src = URL.createObjectURL(file)
            }
        }
