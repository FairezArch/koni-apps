        ...
        <div class="shadow-sm p-3 mb-5 bg-white rounded">
            ...
            <form id="forminput" class="forminput mt-3 mb-3" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="name_atlet" id="name_atlet" class="form-control">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="nomor_npwp" id="nomor_npwp" class="form-control">
                    </div>
                </div>
                <div class="form-group row d-none ">
                ...
                <div class="form-group row d-none">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="nomor_sk_training" id="nomor_sk_training" class="form-control">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4">
                                        ...
                                        <div class="col-md-8">
                                            <div class="preview-image" id="preview-image">
                                                <img src="{{ asset('assets/def_image.svg') }}" alt="default"
                                                    id="imageLoad_photo_profile" width="100" height="auto" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="file_ktp_atlet" class="col-form-label">Berkas KTP</label>
                            <br />
                            <small>Gambar dengan tipe file PNG dan JPG</small>
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    <input type="file" class="custom-file-input file_ktp_atlet"
                                                        id="file_ktp_atlet" aria-describedby="inputGroupFileAddon01"
                                                        name="file_ktp_atlet" hidden />
                                                    <label for="file_ktp_atlet" class="py-2 px-4" style="background-color: #FFC20E;
                                                        color: white;
                                        ...
                                        <div class="col-md-8">
                                            <div class="preview-image" id="preview-image">
                                                <img src="{{ asset('assets/def_image.svg') }}" alt="default"
                                                    id="imageLoad_file_ktp_atlet" width="100" height="auto" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="preview-image" id="preview-image">
                                                <img src="{{ asset('assets/def_image.svg') }}" alt="default"
                                                    id="imageLoad_file_npwp" width="100" height="auto" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            <label for="training_place" class="col-sm-2 col-form-label">Tempat Pelatihan</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group row d-none">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="nomor_status_atlet" id="nomor_status_atlet"
                                    class="form-control">
                            </div>
                        </div>
                    </div>
                ...
                <div class="text-right">
                    <a href="{{ route('sport-branch.atlet.index', $sport_branch->id) }}"
...
@section('script-footer')
    ...
    <script type="text/javascript">
        ...
        $('#forminput').on('submit', function(e) {
            ...
            $.ajax({
                url: "{!! url('sport-branch/"+sport_id+"/atlet') !!}",
                type: "POST",
                processData: false,
                contentType: false,
                data: formData,
                ...
                success: function(res) {
                    if (res.success == true) {
                        window.location.href = "{!! url('sport-branch/"+sport_id+"/atlet') !!}"
                    } else {
                        alert(res.message);
                    }
                },
