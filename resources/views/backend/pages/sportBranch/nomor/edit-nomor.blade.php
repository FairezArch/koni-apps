    ...
    <div class="container-fluid">
        <div class="shadow-sm p-3 mb-5 bg-white rounded">
            ...
            <form id="forminput" class="forminput mt-3 mb-3">
                ...
                <input type="hidden" name="nomor_id" id="nomor_id" value="{{ $lists->id }}">
                <div class="form-group row">
                    <label for="nomor_code" class="col-sm-2 col-form-label">Nomor</label>
                    <div class="col-sm-10">
                        <input type="text" value="{{$lists->nomor_code}}" name="nomor_code" id="nomor_code" class="form-control">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <select name="status" id="status" class="form-control status">
                            ...
                            <option value="0" {{ ($lists->status == 0) ? 'selected=selected' : '' }} >Tidak Aktif</option>
                        </select>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        ...
        $('#forminput').on('submit', function(e) {
            ...
            let sport_id = $('#sport_id').val(), // Sport ID
                nomor_id = $('#nomor_id').val(); // Nomor ID
            ...
            $.ajax({
                url: "{!! url('sport-branch/"+sport_id+"/nomor/"+nomor_id+"') !!}",
                type: "POST",
                processData: false,
                contentType: false,
                data: formData,
