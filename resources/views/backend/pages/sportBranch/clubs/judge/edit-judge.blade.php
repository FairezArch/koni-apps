...
@section('title', '- Edit Wasit Juri')
@section('content')
    <div class="container-fluid">
        <div class="shadow-sm p-3 mb-5 bg-white rounded">
            <h4>Edit Wasit Juri</h4>
            <h5>Data Personal</h5>
            <form id="forminput" class="forminput mt-3 mb-3" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" value="{{$lists->users->phone_number}}" name="phone" id="phone" class="form-control">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <textarea name="address" class="form-control" id="address" cols="30" rows="5" class="w-100">{{ $lists->users->address }}</textarea>
                    </div>
                </div>
                <div class="form-group row">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="show-image fade-image-cust d-inline-block" id="show-image"
                                                        style="width: 150px; height: auto;">
                                                        <img src='{{ asset("storage/judge/".$lists->file_ktp_judge) }}'
                                                            class="img-rounded img-thumbnail" id="imageLoad_file_ktp_judge" />
                                                    </div>
                                                </div>
                                            </div>
                                            @endif
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="show-image fade-image-cust d-inline-block" id="show-image"
                                                        style="width: 150px; height: auto;">
                                                        <img src='{{ asset("storage/judge/".$lists->file_npwp_judge) }}'
                            ...
                            <div class="col-sm-10">
                                <select name="nomors_id" id="nomors_id" class="form-control">
                                    @foreach ($nomors as $nomor)
                                        <option value="{{ $nomor->id }}" {{ $lists->nomor_id == $nomor->id ? 'selected' : '' }}>{{ $nomor->nomor_code }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-10">
                                <select name="certificate_profession" id="certificate_profession" class="form-control">
                                    @foreach ($certificates as $certificate)
                                        <option value="{{ $certificate->id }}" {{ $lists->setting_judge_referees_id == $certificate->id ? 'selected' : '' }} >{{ $certificate->certificate_name }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="col-sm-10">
                                <select name="licence" id="licence" class="form-control">
                                    @foreach ($licences as $licence)
                                        <option value="{{ $licence->id }}" {{ $lists->setting_judge_referee_licences_id == $licence->id ? 'selected' : '' }}>{{ $licence->licence_name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                                        ...
                                        <div class="col-md-10">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="show-image fade-image-cust d-inline-block" id="show-image"
                                                        style="width: 150px; height: auto;">
                                                        <img src='{{ asset("storage/judge/".$lists->file_certificate_judge) }}'
                ...
                <div class="text-right">
                    <a href="{{ route('sport-branch.judge.index', $sport_branch->id) }}"
...
@section('script-footer')
    ...
    <script type="text/javascript">
        ...
        $('#forminput').on('submit', function(e) {
            ...
            let judge_id = "{{$lists->id}}"; // Judge ID
            ...
            $.ajax({
                url: "{!! url('sport-branch/"+sport_id+"/clubs/"+club_id+"/judge/"+judge_id+"') !!}",
                type: "POST",
                processData: false,
                contentType: false,
                data: formData,
                ...
                success: function(res) {
                    if (res.success == true) {
                        window.location.href = "{!! url('sport-branch/"+sport_id+"/clubs/"+club_id+"/judge') !!}"
                    } else {
                        alert(res.message);
                    }
                },
