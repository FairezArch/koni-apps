                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="text-right">
                                <a href="{{ route('sport-branch.clubs.edit', [ $sport_branch->id, $list->id ]) }}" class="text-white">
            ...
            <div class="row m-4">
                <div class="col-md-4">
                    <div class="rounded p-3 mt-3 mb-3 wrapper-box-sport">
                        ...
                        <div class="border-top border-white mt-3 text-right">
                            <a href="{{ route('sport-branch.clubs.atlet.index', [$sport_branch->id, $list->id]) }}"
                ...
                <div class="col-md-4">
                    <div class="rounded p-3 mt-3 mb-3 wrapper-box-sport">
                        <div class="top-box-sport text-center text-dark">
                            <h5>Pelatih</h5>
                            <h6><small>{{ $list->trainers->count() }} Pelatih</small></h6>
                        </div>
                        <div class="border-top border-white mt-3 text-right">
                            <a href="{{ route('sport-branch.clubs.trainer.index', [$sport_branch->id, $list->id]) }}"
                ...
                <div class="col-md-4">
                    <div class="rounded p-3 mt-3 mb-3 wrapper-box-sport">
                        ...
                        <div class="border-top border-white mt-3 text-right">
                            <a href="{{ route('sport-branch.clubs.judge.index', [$sport_branch->id, $list->id]) }}"
                                class="text-white">Lihat Semua</a>
                        </div>
                    </div>
                </div>
