    ...
    <div class="container-fluid">
        <div class="wrapper-table p-3 bg-white rounded">
            <div class="w-100 mt-3 mb-3 text-right">
                @can('trainer-create')
                    <a class="btn btn-danger" href="{{ route('sport-branch.clubs.trainer.create', [$sport_branch->id, $club->id]) }}">Tambah Pelatih</a>
                @endcan
            </div>
    ...
    <script type="text/javascript">
        $(function() {
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        return `@can('trainer-edit')
                                <a href="{{url('sport-branch/`+splitdata[1]+`/clubs/`+splitdata[2]+`/trainer/`+splitdata[0]+`/edit')}}" class='edit m-1'><svg xmlns="http://www.w3.org/2000/svg" width="16"
            ...
            $('body').on('click', '.delete-record', function(e) {
                ...
                let id = $(this).data("id"),
                split  = id.split(','),
                url = "{!!url('sport-branch/"+split[1]+"/clubs/"+split[2]+"/trainer/"+split[0]+"')!!}";
