...
@section('title', '- Tambah Status Pelatih')
@section('content')
    <div class="container-fluid">
        <div class="shadow-sm p-3 mb-5 bg-white rounded">
            <h4>Tambah Status Pelatih</h4>
            <form id="forminput" class="forminput mt-3 mb-3" >
                <div class="form-group row">
                    <label for="status_trainner" class="col-sm-2 col-form-label">Nama Status</label>
                    <div class="col-sm-10">
                        <input type="text" name="status_trainner" id="status_trainner" class="form-control">
                    </div>
                </div>
...
@section('script-footer')
    <script type="text/javascript">
        ...
        $('#forminput').on('submit', function(e) {
            ...
            $.ajax({
                url: "{{ route('setting-status-trainner.store') }}",
                type: "POST",
                processData: false,
                contentType: false,
                data: formData,
