...
@section('title', '- Tambah Support')
@section('content')
    <div class="container-fluid">
        <div class="shadow-sm p-3 mb-5 bg-white rounded">
            <h4>Tambah Support</h4>
            <form id="forminput" class="forminput mt-3 mb-3" >
                ...
                <div class="text-right">
                    <a href="{{ route('setting-support-trainner.index') }}" class="btn btn-danger p-2 rounded">Kembali</a>
...
@section('script-footer')
    <script type="text/javascript">
        ...
        $('#forminput').on('submit', function(e) {
            ...
            $.ajax({
                url: "{{ route('setting-support-trainner.store') }}",
                type: "POST",
                processData: false,
                contentType: false,
                data: formData,
