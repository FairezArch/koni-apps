...
class TrainerInClubController extends Controller
{
    ...
    public function index(Request $request, Sport $sport_branch, Club $club)
    {
        //
        if ($request->ajax()) {
            $data = Trainner::where([$this->sport => $sport_branch->id], [$this->club => $club->id])->with(['sports', 'users', 'certificate_professions', 'status_trainners', 'nomor']);
        ...
        return view('backend.pages.sportBranch.clubs.trainner.index-trainer', compact('sport_branch','club'));
    }
    ...
    public function create(Sport $sport_branch, Club $club)
    {
        ...
        return view('backend.pages.sportBranch.clubs.trainner.add-trainner', compact('sport_branch', 'club', 'nomors', 'status_trainners', 'certificates'));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(StoreTrainnerRequest $request, Sport $sport_branch, Club $club)
    {
        //
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(Sport $sport_branch, Club $club, Trainner $trainer)
    {
        //
        ...
        return view('backend.pages.sportBranch.clubs.trainner.edit-trainner', compact('sport_branch', 'club', 'lists', 'nomors', 'status_trainners', 'certificates'));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(UpdateTrainnerRequest $request, Sport $sport_branch, Club $club, Trainner $trainer)
    {
        //
